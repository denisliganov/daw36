...
: stage1(8), stage2(8), stage3(8)
{
  ...
  double b3[order/3+1];
  double a3[order/3+1];
  biquadCascadeToDirectForm(order/6, halfbandFilterBiquad.getAddressB0(), 
    ...
    b1, a1);
  biquadCascadeToDirectForm(order/6, halfbandFilterBiquad.getAddressB0()+order/6, 
    ...
    b2, a2);
  biquadCascadeToDirectForm(order/6, halfbandFilterBiquad.getAddressB0()+2*order/6, 
