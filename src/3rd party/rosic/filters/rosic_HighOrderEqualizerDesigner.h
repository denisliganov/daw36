#ifndef rosic_HighOrderEqualizerDesigner_h
#define rosic_HighOrderEqualizerDesigner_h
...
namespace rosic
{
  ...
  This class designs (calculates coefficients for) a high order digital equalizer a la Orfanidis.

  */

  class HighOrderEqualizerDesigner  
  {
...
#endif // rosic_HighOrderEqualizerDesigner_h
