...
namespace rosic
{
  ...
  situations in which a very steep filter is desirable such as anti-aliasing and anti-imaging
  in resampling applications. 
  ...
  */
  ...
  public:
    ...
    /** Constructor. Calculates the poles and zeros for the analog unit cutoff prototype filter 
    and stores them in the member arrays prototypePoles and prototypeZeros. */
...
#endif // rosic_EllipticSubBandFilter_h
