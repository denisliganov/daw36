...
void LpfHpfApf::setSampleRate(float newSampleRate)
{
...
void LpfHpfApf::setLowpassCutoff(float newCutoff)
{
...
void LpfHpfApf::setHighpassCutoff(float newCutoff)
{
  if( (newCutoff>=0.0) && (newCutoff<=20000.0) )
    hpfCutoff = newCutoff;	
  else
...
void LpfHpfApf::setAllpassFrequency(float newFrequency)
{
